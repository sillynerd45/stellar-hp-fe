...
class LogListBodyTemperature extends StatelessWidget {
  const LogListBodyTemperature({
    super.key,
              ...
              children: [
                ValueListenableBuilder(
                  ...
                  builder: (context, dailyLog, _) {
                    ...
                    if (dailyLog.bodyTemperature.length <= 3) {
                      showAllButton = false;
                    }
                    return LogListTitle(
                      title: title,
                    ...
                    return Container(
                      ...
                      child: ValueListenableBuilder(
                        ...
                        builder: (context, dailyLog, _) {
                          ...
                          if (dailyLog.bodyTemperature.isEmpty) {
                            return Padding(
                              padding: const EdgeInsets.symmetric(vertical: 1),
                              child: Text(
                          ...
                          int totalItem = dailyLog.bodyTemperature.length;
                          int itemCount = totalItem >= 3 ? 3 : totalItem;
                          return ListView.builder(
                            key: ValueKey('BodyTemperature-LV-${chosenDate.value.unixTime}'),
                            shrinkWrap: true,
                            ...
                            itemBuilder: (BuildContext viewContext, int index) {
                              ...
                              return Column(
                                key: ValueKey('BodyTemperature-${e.epochTimestamp}'),
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
