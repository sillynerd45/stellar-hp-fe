...
class LogListSymptom extends StatelessWidget {
  const LogListSymptom({
    super.key,
    this.title = 'Symptom',
                    ...
                    return Container(
                      ...
                      child: ValueListenableBuilder(
                        ...
                        builder: (context, dailyLog, _) {
                          ...
                          int totalItem = dailyLog.symptom.length;
                          int itemCount = totalItem >= 3 ? 3 : totalItem;
                          return ListView.builder(
                            key: ValueKey('Symptom-LV-${chosenDate.value.unixTime}'),
                            shrinkWrap: true,
                            ...
                            itemBuilder: (BuildContext viewContext, int index) {
                              ...
                              return Column(
                                key: ValueKey('Symptom-${e.epochTimestamp}'),
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
